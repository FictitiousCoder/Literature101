...
class UserTools {
    ...
    //Check to see if a e-mail exists.
	//This is called during registration to make sure all user e-mails are unique.
    ...
    public function checkEditor ($id) {
        if (mysql_query("select editor from users where id='$id'")==0) {
            return false;
        }
        else {
            return true;
